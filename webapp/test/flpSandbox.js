		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inovices List",
									"targetURL": "#logalilgroupinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalilgroupinvoices-display": {
								"semanticObject": "logalilgroupinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logalilgroup.invoices",
									"url": sap.ui.require.toUrl("logalilgroup/invoices")
								}
							}
						}
					}
